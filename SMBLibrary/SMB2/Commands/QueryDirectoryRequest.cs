...
namespace SMBLibrary.SMB2
{
    ...
    public class QueryDirectoryRequest : SMB2Command
    {
        ...
        public bool Restart
        {
            get => ((this.Flags & QueryDirectoryFlags.SMB2_RESTART_SCANS) > 0);
            set
            {
                if (value)
                {
        ...
        {
            get => ((this.Flags & QueryDirectoryFlags.SMB2_RETURN_SINGLE_ENTRY) > 0);
            set
            {
                if (value)
                {
        ...
        public bool Reopen
        {
            get => ((this.Flags & QueryDirectoryFlags.SMB2_REOPEN) > 0);
            set
            {
                if (value)
                {
