...
namespace SMBLibrary.Authentication.NTLM
{
    public class AVPairUtils
    {
        ...
        {
            KeyValuePairList<AVPairKey, byte[]> pairs = new KeyValuePairList<AVPairKey, byte[]> {{AVPairKey.NbDomainName, Encoding.Unicode.GetBytes(domainName)}, {AVPairKey.NbComputerName, Encoding.Unicode.GetBytes(computerName)}};
            return pairs;
        }
