...
namespace SMBLibrary.Tests
{
    public class SMB2SigningTests
    {
        ...
        public void TestSMB202SignatureCalculation()
        {
            ...
            byte[] expected = { 0xfb, 0xd2, 0x84, 0x34, 0x03, 0x24, 0xc6, 0x2f, 0xbe, 0xbb, 0x65, 0xdd, 0x10, 0x51, 0xf3, 0xae };
        ...
        public void TestSMB210SignatureCalculation()
        {
            ...
            signature = ByteReader.ReadBytes(signature, 0, 16);
            byte[] expected = { 0xa1, 0x64, 0xff, 0xe5, 0x3d, 0x68, 0x11, 0x98, 0x1f, 0x38, 0x67, 0x72, 0xe3, 0x87, 0xe0, 0x6f };
            Assert.True(ByteUtils.AreByteArraysEqual(signature, expected));
        }
        ...
        public void TestSMB300SignatureCalculation()
        {
            ...
            signature = ByteReader.ReadBytes(signature, 0, 16);
            byte[] expected = { 0x73, 0xF2, 0xCC, 0x56, 0x09, 0x3E, 0xD2, 0xB5, 0xD7, 0x10, 0x66, 0x6C, 0xE4, 0x28, 0x2D, 0xD1 };
            Assert.True(ByteUtils.AreByteArraysEqual(signature, expected));
        }
